...
def create_collage(collage_size, size, from_dir, dest_dir, collages_amount, random_images, *images):
    ...
    for col in range(collages_amount):
        actual_index = 0
        columns = []
...
create_collage((5, 5), (1920, 1440), 'test_images', 'generated_collages', 3, False)